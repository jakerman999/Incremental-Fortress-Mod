...
var effectiveness = {
  ...
  var newRUI = Function(oldRUI.toString().slice(25,-3).replace(`//tower1`,`//tower1
  ...
  .replace(`ogres_button.html( 'Ogres: ' + numT(tower1.ogres) + '<br><span class="tiny">Power: +' + numT((tower1.ogres_power + tower3.cheiroballistras*tower3.cheiroballistras_power)*winecellar.drunk[3]) + '/s<br>Price: ' + numT(tower1.ogres_price[tower1.buy_amount_index]) + '</span>' );`,`ogres_button.html( 'Ogres: ' + numT(tower1.ogres) + '<br><span class="tiny">Power: +' + numT(powers.ogres) + '/s<br>Price: ' + numT(prices.ogres) + '<br>Effectiveness:' + numT(effectiveness.ogres/effMod) + '</span>' );`));
